                ...
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/category" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="cateName" class="form-control" placeholder="Enter category name" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-card-text text-secondary me-1"></i> Category Description</label>
                            <textarea name="cateDes" class="form-control" rows="4" placeholder="Enter a brief description for this category..."></textarea>
                        </div>
