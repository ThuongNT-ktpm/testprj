                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody> 
                            <c:forEach items="${listCate}" var="c">
                                <tr>
                                    <td><strong class="text-secondary">#CAT-${c.cateId}</strong></td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <a href="category?action=update&id=${c.cateId}" class="btn btn-warning btn-action text-dark me-1" title="Edit">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>
                                        <a href="${pageContext.request.contextPath}/category?action=delete&id=${c.cateId}" 
                            ...
                            <c:if test="${empty listCate}">
                                <tr>
                                    <td colspan="4" class="text-center py-5 text-muted">
                                        ...
                                        <p class="mb-0">Create categories to organize your products efficiently.</p>
                                    </td>
                                </tr>
                            </c:if>
                        </tbody>
