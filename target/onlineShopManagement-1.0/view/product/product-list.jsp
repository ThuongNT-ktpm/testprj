                        ...
                        <tbody> 
                            <c:forEach items="${listPro}" var="p">
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${p.proQuantity == 0}">
                                                <span class="text-danger fw-bold"><i class="bi bi-exclamation-triangle-fill me-1"></i> Out of Stock</span>
                                            </c:when>
                                            <c:otherwise>
                                                ${p.proQuantity}
                                            </c:otherwise>
                                    ...
                                    <td>
                                        <span class="badge bg-info text-dark badge-category">${p.cateId.cateName}</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="product?action=update&id=${p.proId}" class="btn btn-warning btn-action text-dark me-1" title="Edit">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>
                                        <a href="${pageContext.request.contextPath}/product?action=delete&id=${p.proId}" 
                            ...
                            <c:if test="${empty listPro}">
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">
                                        ...
                                        <p class="mb-0">Click "Add New Product" to stock your inventory.</p>
                                    </td>
                                </tr>
                            </c:if>
                        </tbody>
