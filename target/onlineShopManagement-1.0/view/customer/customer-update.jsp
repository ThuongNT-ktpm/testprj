...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="${pageContext.request.contextPath}/customer" class="active"><i class="bi bi-person-lines-fill"></i> Customers</a>
    ...
    <div class="main-content">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header">
                <h4 class="page-title">
                    <a href="${pageContext.request.contextPath}/customer" class="text-secondary text-decoration-none">
            ...
            <div class="card-box">
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/customer" method="post">
                        ...
                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-hash text-secondary me-1"></i> Customer ID</label>
                            <input type="text" name="cusId" class="form-control" value="${listCus.cusId}" readonly>
                            <div class="form-text text-muted small mt-1">ID is auto-generated and cannot be modified.</div>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-person-badge text-secondary me-1"></i> Full Name <span class="text-danger">*</span></label>
                            <input type="text" name="cusName" class="form-control" value="${listCus.cusName}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-telephone text-secondary me-1"></i> Phone Number <span class="text-danger">*</span></label>
                            <input type="text" name="cusPhone" class="form-control" value="${listCus.cusPhone}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-envelope text-secondary me-1"></i> Email <span class="text-danger">*</span></label>
                            <input type="email" name="cusEmail" class="form-control" value="${listCus.cusEmail}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-geo-alt text-secondary me-1"></i> Address <span class="text-danger">*</span></label>
                            <input type="text" name="cusAddress" class="form-control" value="${listCus.cusAddress}" required>
                        </div>
                        ...
                        <div class="d-flex gap-3">
                            <button type="submit" class="btn btn-warning px-4 text-dark fw-medium">
                                <i class="bi bi-pencil-square me-1"></i> Update Customer
                            </button>
                            <a href="${pageContext.request.contextPath}/customer" class="btn btn-light border px-4">
                                Cancel
                            </a>
                        </div>
                    </form>
