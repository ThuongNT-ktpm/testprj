                ...
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/customer" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="cusName" class="form-control" placeholder="Enter customer's name" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-telephone text-secondary me-1"></i> Phone Number <span class="text-danger">*</span></label>
                            <input type="text" name="cusPhone" class="form-control" placeholder="Enter phone number" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-envelope text-secondary me-1"></i> Email <span class="text-danger">*</span></label>
                            <input type="email" name="cusEmail" class="form-control" placeholder="example@email.com" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-geo-alt text-secondary me-1"></i> Address <span class="text-danger">*</span></label>
                            <input type="text" name="cusAddress" class="form-control" placeholder="Enter full address" required>
                        </div>
