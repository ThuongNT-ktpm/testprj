                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody> 
                            <c:forEach items="${listCus}" var="c">
                                <tr>
                                    <td><strong>#CUS-${c.cusId}</strong></td>
                                    <td>
                                    ...
                                    <td>
                                        <div><i class="bi bi-telephone text-muted me-1"></i> ${c.cusPhone}</div>
                                        <div class="text-muted small"><i class="bi bi-envelope me-1"></i> ${c.cusEmail}</div>
                                    </td>
                                    <td>
                                        <i class="bi bi-geo-alt text-muted me-1"></i> ${c.cusAddress}
                                    </td>
                                    <td class="text-center">
                                        <a href="customer?action=update&id=${c.cusId}" class="btn btn-warning btn-action text-dark me-1" title="Edit">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>
                                        <a href="customer?action=delete&id=${c.cusId}" 
                            ...
                            <c:if test="${empty listCus}">
                                <tr>
                                    <td colspan="5" class="text-center py-5 text-muted">
                                        ...
                                        <p class="mb-0">Click "Add New Customer" to register your first client.</p>
                                    </td>
                                </tr>
                            </c:if>
                        </tbody>
