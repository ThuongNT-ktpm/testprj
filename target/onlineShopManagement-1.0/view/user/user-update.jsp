    ...
    <div class="main-content">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header">
                <h4 class="page-title">
                    <a href="${pageContext.request.contextPath}/user" class="text-secondary text-decoration-none">
            ...
            <div class="card-box">
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/user" method="post">
                        ...
                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-hash text-secondary me-1"></i> User ID</label>
                            <input type="number" name="userId" class="form-control" value="${listUpdate.userId}" readonly>
                            <div class="form-text text-muted small mt-1">ID is auto-generated and cannot be modified.</div>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-person text-secondary me-1"></i> Username <span class="text-danger">*</span></label>
                            <input type="text" name="userName" class="form-control" value="${listUpdate.userName}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-envelope text-secondary me-1"></i> Email <span class="text-danger">*</span></label>
                            <input type="email" name="userEmail" class="form-control" value="${listUpdate.userEmail}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-lock text-secondary me-1"></i> Password <span class="text-danger">*</span></label>
                            <input type="password" name="userPass" class="form-control" value="${listUpdate.userPass}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-shield-lock text-secondary me-1"></i> Role</label>
                            <select name="userRole" class="form-select">
                                <option value="Admin" ${listUpdate.userRole == 'Admin' ? 'selected' : ''}>Admin</option>
                                <option value="Staff" ${listUpdate.userRole == 'Staff' ? 'selected' : ''}>Staff</option>
                            </select>
                        </div>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <a href="${pageContext.request.contextPath}/user" class="btn btn-light border px-4">
                                Cancel
                            </a>
                        </div>
                    </form>
