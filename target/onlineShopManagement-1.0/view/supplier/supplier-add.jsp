...
<head>
    ...
    <style>
        ...
        /* --- Form Styling --- */
        .form-container {
            max-width: 600px; /* Giới hạn độ rộng form */
        }
                ...
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/supplier" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="supName" class="form-control" placeholder="Enter supplier name" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-telephone text-secondary me-1"></i> Phone Number <span class="text-danger">*</span></label>
                            <input type="text" name="supPhone" class="form-control" placeholder="Enter phone number" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-geo-alt text-secondary me-1"></i> Address <span class="text-danger">*</span></label>
                            <input type="text" name="supAddress" class="form-control" placeholder="Enter full address" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-envelope text-secondary me-1"></i> Email <span class="text-danger">*</span></label>
                            <input type="email" name="supEmail" class="form-control" placeholder="contact@supplier.com" required>
                        </div>
