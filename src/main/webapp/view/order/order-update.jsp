            ...
            <div class="card-box">
                <div class="form-container">
                    ...
                    <form action="order" method="post">
                        ...
                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-hash text-secondary me-1"></i> Order ID</label>
                            <input type="text" name="id" class="form-control fw-bold text-primary" value="${order.orderID}" readonly>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <label class="form-label"><i class="bi bi-calendar3 text-secondary me-1"></i> Order Date <span class="text-danger">*</span></label>
                                <input type="date" name="date" class="form-control" value="${order.orderDate}" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="total" class="form-control" value="${order.orderTotal_price}" min="0" required>
                                </div>
                            </div>
                        </div>
