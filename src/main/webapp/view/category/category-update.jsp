...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="${pageContext.request.contextPath}/category" class="active"><i class="bi bi-tags"></i> Categories</a>
    ...
    <div class="main-content">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header">
                <h4 class="page-title">
                    <a href="${pageContext.request.contextPath}/category" class="text-secondary text-decoration-none">
            ...
            <div class="card-box">
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/category" method="post">
                        ...
                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-hash text-secondary me-1"></i> Category ID</label>
                            <input type="text" name="cateId" class="form-control" value="${listCate.cateId}" readonly>
                            <div class="form-text text-muted small mt-1">ID is auto-generated and cannot be modified.</div>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-tag text-secondary me-1"></i> Category Name <span class="text-danger">*</span></label>
                            <input type="text" name="cateName" class="form-control" value="${listCate.cateName}" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-card-text text-secondary me-1"></i> Category Description</label>
                            <textarea name="cateDes" class="form-control" rows="4" placeholder="Enter a brief description for this category...">${listCate.cateDes}</textarea>
                        </div>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <a href="${pageContext.request.contextPath}/category" class="btn btn-light border px-4">
                                Cancel
                            </a>
                        </div>
                    </form>
