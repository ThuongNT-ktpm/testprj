...
<head>
    ...
    <style>
        ...
        /* --- Form Styling --- */
        .form-container {
            max-width: 600px; /* Giới hạn độ rộng của form để nhìn gọn gàng */
        }
                ...
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/user" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="userPass" class="form-control" placeholder="Enter secure password" required>
                        </div>
